...
Member.objects.bulk_create([
    ...
    Member(name='ben', name_chn='俞斌辉', nick_name='本本', number=101,
           pos1='攻击型中场', pos2='防守型中场', pos3='中后卫',
           top_star=0, all_pos=1, stamina=1, athletic=1, grade=5),
    Member(name='arthur', name_chn='余刚', nick_name='阿色', number=101,
    ...
    Member(name='symon', name_chn='陶晓鸣', nick_name='西门', number=82,
           pos1='中后卫', pos2='边后卫', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=6),
    Member(name='tao', name_chn='陶新', nick_name='华弟', number=101,
    ...
    Member(name='rp', name_chn='朱律均', nick_name='人品', number=101,
           pos1='前锋', pos2='攻击型中场', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=5),
    Member(name='sky', name_chn='吕旻', nick_name='天天', number=6,
           pos1='攻击型中场', pos2='防守型中场', pos3='防守型中场',
    ...
    Member(name='j8', name_chn='姚俊', nick_name='姚俊', number=101,
           pos1='防守型中场', pos2='中后卫', pos3='攻击型中场',
    ...
    Member(name='yh', name_chn='严慧', nick_name='鞋魔', number=101,
           pos1='边后卫', pos2='中后卫', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=8),
    ...
    Member(name='alson', name_chn='', nick_name='Alson', number=101,
           pos1='攻击型中场', pos2='防守型中场', pos3='边后卫',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=6),
    Member(name='captain', name_chn='王晓铭', nick_name='队长', number=27,
           pos1='前锋', pos2='', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=1, grade=1),
    Member(name='henry', name_chn='黄毅', nick_name='酋王', number=5,
           pos1='防守型中场', pos2='边后卫', pos3='中后卫',
           top_star=0, all_pos=1, stamina=0, athletic=0, grade=6),
    Member(name='lin', name_chn='林舜宇', nick_name='小林', number=101,
           pos1='攻击型中场', pos2='边后卫', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=7),
    ...
    Member(name='tarou', name_chn='谭芃', nick_name='太郎', number=29,
           pos1='边后卫', pos2='前锋', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=7),
    Member(name='chang', name_chn='常力鹏', nick_name='柱子', number=101,
    ...
    Member(name='sprite', name_chn='王金亮', nick_name='金亮', number=81,
           pos1='中后卫', pos2='防守型中场', pos3='边后卫',
           top_star=0, all_pos=0, stamina=0, athletic=1, grade=4),
    Member(name='xiaop', name_chn='汪远', nick_name='小P', number=13,
           pos1='边后卫', pos2='攻击型中场', pos3='防守型中场',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=6),
    Member(name='hao', name_chn='刘豪', nick_name='小舅子', number=101,
    ...
    Member(name='eric', name_chn='汪健', nick_name='艾里克', number=99,
           ...
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=8),
    Member(name='tieta', name_chn='', nick_name='铁塔', number=9,
           pos1='防守型中场', pos2='攻击型中场', pos3='',
           top_star=1, all_pos=0, stamina=0, athletic=1, grade=2),
    Member(name='elvin', name_chn='', nick_name='艾尔文', number=33,
           pos1='防守型中场', pos2='攻击型中场', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=8),
    Member(name='flemming', name_chn='', nick_name='弗莱明', number=101,
    ...
    Member(name='blue', name_chn='王逸洲', nick_name='蓝少', number=2,
           pos1='攻击型中场', pos2='边后卫', pos3='防守型中场',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=5),
    Member(name='wind', name_chn='李靓', nick_name='枭风', number=30,
           pos1='特殊', pos2='', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=8),
    Member(name='gorden', name_chn='顾剑锋', nick_name='戈登', number=77,
           pos1='攻击型中场', pos2='攻击型中场', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=5),
    Member(name='fish', name_chn='', nick_name='小鱼', number=101,
           pos1='防守型中场', pos2='', pos3='前锋',
           top_star=1, all_pos=1, stamina=1, athletic=1, grade=2),
    Member(name='dap', name_chn='', nick_name='大派', number=19,
    ...
    Member(name='le', name_chn='', nick_name='阿乐', number=101,
           pos1='攻击型中场', pos2='防守型中场', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=7),
    Member(name='tim', name_chn='', nick_name='蒂姆', number=52,
           pos1='特殊', pos2='', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=7),
    Member(name='ball', name_chn='许敏', nick_name='球球', number=91,
           pos1='中后卫', pos2='防守型中场', pos3='边后卫',
           top_star=0, all_pos=1, stamina=0, athletic=0, grade=6),
    Member(name='kevin', name_chn='裔立峰', nick_name='凯文', number=101,
           pos1='攻击型中场', pos2='边后卫', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=8),
    Member(name='johnson', name_chn='王祥', nick_name='强森', number=28,
           pos1='攻击型中场', pos2='边后卫', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=5),
    Member(name='guoqi', name_chn='郭琦', nick_name='莹川', number=8,
           pos1='攻击型中场', pos2='边后卫', pos3='前锋',
           top_star=0, all_pos=0, stamina=0, athletic=0, grade=5),
    Member(name='bruce', name_chn='俞星辰', nick_name='布鲁斯', number=31,
           pos1='防守型中场', pos2='攻击型中场', pos3='前锋',
           top_star=1, all_pos=1, stamina=1, athletic=1, grade=2),
Member(name='daqiang', name_chn='姚强', nick_name='大强', number=3,
           pos1='边后卫', pos2='', pos3='',
           top_star=0, all_pos=0, stamina=0, athletic=1, grade=7),
])
